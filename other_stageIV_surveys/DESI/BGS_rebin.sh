...
tracer=BGS
# rms of random redshift error and systematics error, i.e. \sqrt(0.00003^2+0.000022^2)
sigma_specz=0.00004    
...
input_nzfile="./input/rebin/nz_bias_f_Sigmanl_DESI_${tracer}_Adame_2023a.txt"
params_dir="./"
pk_dir0="./"
sigma_dir0="./"
