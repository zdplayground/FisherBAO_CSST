...
sigma_specz=0.00041   
#sigma_specz=0.000041  # a fake small number, 10 times smaller than the true
#sigma_specz=0.0000041  # a fake small number, 100 times smaller than the true
      ...
      for Sigma_fog in 0.1; do
        ...
        for sigma_photoz in 0.025; do
          ...
          for with_recon in False True; do
            ...
            ## test the influence from the spec-z error 
#            pkmu_dir="${pk_dir0}/output/pkmu/vary_params_${const_low}_${const_up}/Sigma_fog_${Sigma_fog}/${dir1}/k_width${k_width}/Pspecz_sys${Pspecz_sys}/params_bf1.0/${tracer}/${zmin}z${zmax}_${nzbins}bins/speczerr${sigma_specz}/"
#            sigalpha_dir="${sigma_dir0}/output/sigma_alpha/vary_params_${const_low}_${const_up}/Sigma_fog_${Sigma_fog}/$dir1/k_width${k_width}/Pspecz_sys${Pspecz_sys}/params_bf1.0/${tracer}/${zmin}z${zmax}_${nzbins}bins/speczerr${sigma_specz}/"
