...
##f0eff=0.5  # it scales the spec-z number density via f0eff/(1+z), the default case f0eff=0.5
Pspecz_sys_list=(2.e2 4.e2 6.e2 8.e2 1.e3 2.e3 3.e3 4.e3 5.e3 6.e3 7.e3 8.e3 9.e3 1.e4)
Pspecz_sys=${Pspecz_sys_list[$PBS_ARRAYID]}
echo "Pspecz_sys: ${Pspecz_sys}"
      ...
      for Sigma_fog in 7.0; do
        ...
        for sigma_photoz in 0.025; do
          ...
          for with_recon in False; do
            ...
            ## ---- for param_bf=1.0
            pkmu_dir="${pk_dir0}/output/pkmu/vary_params_${const_low}_${const_up}/Sigma_fog_${Sigma_fog}/${dir1}/k_width${k_width}/Pspecz_sys${Pspecz_sys}/params_bf1.0/f0eff${f0eff}/"
            sigalpha_dir="${sigma_dir0}/output/sigma_alpha/vary_params_${const_low}_${const_up}/Sigma_fog_${Sigma_fog}/$dir1/k_width${k_width}/Pspecz_sys${Pspecz_sys}/params_bf1.0/f0eff${f0eff}/"
