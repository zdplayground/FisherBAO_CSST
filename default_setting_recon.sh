...
# copy it from default_setting.sh, consider the spec-z forecast with reconstructio, setting Sigma_fog close to 0
      ...
      for Sigma_fog in 0.1; do
        ...
        for sigma_photoz in 0.025; do
          ...
          for with_recon in True; do
            ...
            time python ../secondgen/fisher_singletracer.py --survey_area ${survey_area} --kmax $kmax --zmin $zmin --zmax $zmax --nzbins $nzbins --sigma_specz ${sigma_specz} --sigma_photoz ${sigma_photoz} --Sigma_fog ${Sigma_fog} --const_low ${const_low} --const_up ${const_up} --tracer specz  --input_dir ${pkmu_dir} --output_dir ${sigalpha_dir}

#            time python ../secondgen/fisher_singletracer.py --survey_area ${survey_area} --kmax $kmax --zmin $zmin --zmax $zmax --nzbins $nzbins --sigma_specz ${sigma_specz} --sigma_photoz ${sigma_photoz} --Sigma_fog ${Sigma_fog} --const_low ${const_low} --const_up ${const_up} --tracer photoz --input_dir ${pkmu_dir} --output_dir ${sigalpha_dir}


#            time python ../secondgen/fisher_specz_add_cross.py --survey_area ${survey_area} --kmax $kmax --zmin $zmin --zmax $zmax --nzbins $nzbins --sigma_specz ${sigma_specz} --sigma_photoz ${sigma_photoz} --Sigma_fog ${Sigma_fog} --const_low ${const_low} --const_up ${const_up}  --input_dir ${pkmu_dir} --output_dir ${sigalpha_dir}

#            time python ../secondgen/fisher_specz_photoz_add_cross.py --survey_area ${survey_area} --kmax $kmax --zmin $zmin --zmax $zmax --nzbins $nzbins --sigma_specz ${sigma_specz} --sigma_photoz ${sigma_photoz} --Sigma_fog ${Sigma_fog} --const_low ${const_low} --const_up ${const_up}  --input_dir ${pkmu_dir} --output_dir ${sigalpha_dir}
